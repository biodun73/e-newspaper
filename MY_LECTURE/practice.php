...
*/
//
$stmt =  $link->prepare("INSERT INTO registration(firstname,lastname,dat,textarea)VALUES(':firstname',':lastname',':newdat',':textarea')");

$q = array(
    ':firstname' => filter_input(INPUT_POST,'first'),
    ':lastname' => filter_input(INPUT_POST,'last'),
    ':newdat' => filter_input(INPUT_POST,'dat'),
