...
?>
<h2 style="text-align: center;background-color: red;margin-top: 10px;display: block;color:white">BUSINESS NEWS</h2>
<?php
...
while ($row = mysqli_fetch_assoc($query)) {
    ...
    padding:10px;margin-bottom:200px;text-decoration:none;color:black'>";
