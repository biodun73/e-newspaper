<?php session_start();?>
<h2  style="text-align: center;background-color: red;margin-top: 10px;display: block;color:white;">LOCAL  NEWS</h2>
<?php
